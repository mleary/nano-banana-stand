...
class GenerationServiceTests(unittest.TestCase):
    def test_validate_generation_request_rejects_reference_tokens_for_openai(self):
        ...
        with self.assertRaisesRegex(ValueError, "require Google Gemini"):
    ...
    def test_generate_and_store_persists_normalized_metadata(
        ...
        self.assertEqual(outcome.generation_id, 42)
        self.assertEqual(outcome.image_bytes, b"image-bytes")
        self.assertEqual(outcome.missing_references, ["missing_logo"])

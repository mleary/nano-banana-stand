    ...
    st.markdown(
        ...
        <div style="text-align: center; margin-top: 1.5rem; opacity: 0.6;">
          <a href="{GITHUB_REPO_URL}" target="_blank" title="View on GitHub"
             style="color: inherit; text-decoration: none; display: inline-flex; align-items: center; gap: 0.4rem; font-size: 0.85rem;">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" width="18" height="18" style="fill: currentColor; vertical-align: middle;">
